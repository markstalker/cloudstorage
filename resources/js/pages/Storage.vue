<template>
    ...
    <div v-else>
        <confirm-modal v-model="showModal" name="confirm" @confirm="closeDeleteConfirm" @cancel="showModal = false">
                            ...
                            <tr v-for="file in files" class="bg-white border-b">
                                <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                    <div class="flex item-center justify-center space-x-3">
                                        ...
                                        <button class="w-5 transform hover:text-indigo-600 hover:scale-110" @click="openDeleteConfirm(file.id)">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
